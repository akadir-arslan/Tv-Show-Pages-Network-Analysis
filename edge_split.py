# The class EdgeSplitter is derived from the EdgeSplitter of the StellarGraph library, 
# which is provided under the license below.
# The StellarGraph library is however only available for Python >=3.6.0, <3.9.0 
# Source: https://pypi.org/project/stellargraph/
